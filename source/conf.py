...
.. raw:: html
    ...
    <div class="admonition note">
      ...
      <a class="reference external" href="https://github.com/cameronraysmith/biostatistics-review/blob/master/{{ docname|e }}">{{ docname|e }}</a>.
      <span style="white-space: nowrap;"><a href="https://mybinder.org/v2/gh/cameronraysmith/biostatistics-review/master?filepath={{ docname|e }}"><img alt="Binder badge" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a> or </span>
      <script>
